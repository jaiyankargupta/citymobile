...
const ShopVijayCinemaPage: React.FC = () => {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-br from-purple-600 via-pink-600 to-red-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full border border-white/30 mb-6">
            ...
            <span className="text-sm font-medium">Near Vijay Cinema</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-purple-100 max-w-3xl mx-auto leading-relaxed">
            Ground Floor, Vijay-Cinema, Sonar-Patti Road, Par-805110
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-10">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 mb-10 border border-gray-100">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <a
                href="https://jsdl.in/DT-993R7C7CF9L"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <a
                href="https://maps.app.goo.gl/bht2GJKEXwocP9kB7"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Ground Floor, Vijay-Cinema, Sonar-Patti Road, Par-805110</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+91 9155582054</p>
                    <p className="text-gray-600">Call Now: +91 9155582054</p>
                    <p className="text-gray-600">WhatsApp: +91 9155582054</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  <StarIcon className="h-6 w-6 text-purple-600 mt-1" />
                  <div>
        ...
        <div className="text-center mb-8">
          <Link 
            to="/shops" 
            className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-xl hover:from-purple-700 hover:to-pink-700 transform hover:-translate-y-1 transition-all duration-300 shadow-lg hover:shadow-xl"
          >
...
export default ShopVijayCinemaPage;
