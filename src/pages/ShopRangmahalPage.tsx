...
const ShopRangmahalPage: React.FC = () => {
      ...
      <div className="bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full border border-white/30 mb-6">
            ...
            <span className="text-sm font-medium">Near Rangmahal</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-indigo-100 max-w-3xl mx-auto leading-relaxed">
            Near Rangmahal, Sonar Patti Road, Par Nawada
          </p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 mb-12 border border-gray-100">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <a
                href="https://jsdl.in/DT-993ES14NUG2"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <a
                href="https://maps.google.com/?q=City+Mobile+Selection+Near+Rangmahal+Nawada+Bihar"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Near Rangmahal, Sonar Patti Road, Par Nawada, Nawada - 805110</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+91 7004100548</p>
                    <p className="text-gray-600">Call Now: +91 7004100548</p>
                    <p className="text-gray-600">WhatsApp: +91 7004100548</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  <StarIcon className="h-6 w-6 text-indigo-600 mt-1" />
                  <div>
                    ...
                    <p className="text-gray-600">5 years in business</p>
                  </div>
                </div>
              </div>
            </div>
...
export default ShopRangmahalPage;
